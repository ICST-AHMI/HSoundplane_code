...
,
		...
		"style" : "",
		"subpatcher_template" : "",
		"globalpatchername" : "skin_template",
		"boxes" : [ 			{
				"box" : 				{
					"id" : "obj-31",
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 93.0, 194.0, 80.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 67.5, 128.5, 80.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.5, 103.0, 49.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 37.5, 49.0, 18.0 ],
					"text" : "autopitch",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 37.5, 132.0, 38.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 60.0, 45.0, 20.0 ],
					"text" : "off",
					"texton" : "on",
					"usebgoncolor" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 93.0, 125.0, 80.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 67.5, 60.0, 80.0, 22.0 ],
					"tricolor" : [ 0.317647, 0.654902, 0.976471, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.0, 132.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 491.0, 103.0, 48.0, 22.0 ],
					"text" : "del 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 478.0, 53.0, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.0, 200.0, 147.0, 22.0 ],
					"text" : "pattrmarker skin_template"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 62.5, 373.33984375, 90.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"env_1" : [ 0.0 ],
						"gain" : [ 0.0 ],
						"highFreq" : [ 1224.409448818896863 ],
						"lowFreq" : [ 708.661417322833927 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.0, 168.0, 238.0, 22.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage synth_template @savemode 3",
					"varname" : "synth_template"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 125.5, 596.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 340.0, 50.5, 19.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmax" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 8.0, 188.0, 22.0 ],
					"text" : "Haptics Template",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 103.0, 80.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 67.5, 37.5, 80.0, 18.0 ],
					"text" : "fixed requency",
					"textcolor" : [ 0.847058832645416, 0.847058832645416, 0.847058832645416, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 174.0, 71.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 67.5, 106.0, 71.0, 18.0 ],
					"text" : "transpose",
					"textcolor" : [ 0.847058832645416, 0.847058832645416, 0.847058832645416, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 34.0, 55.5, 67.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 2.886725425720215, 292.0, 32.226547241210938 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 61.0, 34.0, 234.0, 67.0 ],
					"proportion" : 0.5
				}
